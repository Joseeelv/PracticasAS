...
CREATE TABLE Direccion (
    Id_direccion INT SERIAL PRIMARY KEY,
    Ciudad VARCHAR(50),
    Calle VARCHAR(50)
);
...
CREATE TABLE Hospital (
    Id_hospital INT SERIAL PRIMARY KEY,
...
CREATE TABLE Paciente (
    Id_paciente INT SERIAL PRIMARY KEY,
    Nombre VARCHAR(50),
...
CREATE TABLE Medico (
    Id_medico INT SERIAL PRIMARY KEY,
    Id_departamento INT,
    Nombre VARCHAR(50),
    Apellidos VARCHAR(50),
    Telefono INT,
...
CREATE TABLE Diagnostico (
    Id_diagnostico INT SERIAL PRIMARY KEY,
...
CREATE TABLE Cita (
    Id_cita INT SERIAL PRIMARY KEY,
    Id_medico INT,
    Id_paciente INT,
    Id_diagnostico INT,
    Fecha DATE,
...
CREATE TABLE Medicamento (
    Id_medicamento INT SERIAL PRIMARY KEY,
    Id_diagnostico INT,
    Nombre VARCHAR(50),
