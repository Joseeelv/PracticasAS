...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt = mysqli_prepare($conexion, $sql)) {
        ...
        mysqli_stmt_bind_param($stmt, "si", $email, $pin);
        ...
        if (mysqli_stmt_fetch($stmt)) {
            ...
            $_SESSION['error'] = "Las credenciales de inicio de sesión son incorrectas. Por favor, inténtalo de nuevo.";
        }
...
if (isset($_SESSION['error'])) {
    echo "<br><br><br><br><hr style='border-top: 3px solid red; border-bottom: 3px solid red;'><p style='color:red; text-align:center; font-size: 1.5em;'>".$_SESSION['error']."</p><hr style='border-top: 3px solid red; border-bottom: 3px solid red;'>";
